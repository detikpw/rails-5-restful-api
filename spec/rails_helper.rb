...
# https://github.com/thoughtbot/shoulda-matchers/issues/913#issuecomment-219187051
# the serialized_attributes method has been removed from Rails 5 which will cause issues within the same method on the rails_shim
module Shoulda
  module Matchers
